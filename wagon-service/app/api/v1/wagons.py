...
from app.schemas.wagon import PaginatedWagons, WagonDetail, WagonFilters
...
async def list_wagons(
    ...
    sort_by: Annotated[str, Query(description="Поле сортировки")] = "current_city",
    sort_dir: Annotated[str, Query(description="asc | desc")] = "asc",
    # Зависимости
